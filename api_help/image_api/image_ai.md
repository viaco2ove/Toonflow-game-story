## 图片API
### ai生图（价格高，别乱调用）
curl 'http://122.51.232.171:60002/game/generateImage' \
...
### 分离人体和背景。 在ai 故事里显示的是人体。（对接了本地模型。尽情调用吧）
...
curl 'http://122.51.232.171:60002/game/separateRoleAvatar' \
  ...
  -H 'Referer: http://122.51.232.171/' \
  -H 'User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/132.0.0.0 Safari/537.36' \
  --data-raw '{"projectId":1,"fileName":"7ec96b06-4481-4571-8cfb-366f17cd6cea.jpg","name":"npc","base64Data":"data:image/jpeg;base64,/9j/4AAQSkZJRgABAQAAAQABAAD/6....","asyncTask":true}' \
  --insecure


### 人体与背景的分离进度
curl 'http://122.51.232.171:60002/game/separateRoleAvatar/status' \
  -H 'Accept: application/json, text/plain, */*' \
  -H 'Accept-Language: zh-CN,zh;q=0.9' \
  -H 'Authorization: Bearer xxx' \
  -H 'Content-Type: application/json' \
