...
curl 'https://gateway.chub.ai/authentication/login' \
  ...
  -H 'sec-fetch-site: same-site' \
  -H 'user-agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/132.0.0.0 Safari/537.36' \
  --data-raw '{"csrf_token":"***REMOVED***","email_or_username":"***REMOVED***","password":"***REMOVED***","oauth":null,"state":"","redirect_url":"https://chub.ai/login","is_mobile":"false"}'
...
curl 'https://ro.chub.ai/search?first=50&namespace=characters&nsfw=true&nsfl=true&chub=true&count=false&topics=&exclude_mine=false&include_forks=true&sort=created_at&search=&username=***REMOVED***&only_mine=all&my_favorites=false&min_tokens=0&page=1&bypass=true' \
  -H 'accept: */*' \
  -H 'accept-language: zh-CN,zh;q=0.9' \
  -H 'ch-api-key: ***REMOVED***' \
  -H 'content-type: application/json' \
...
# https://chub.ai/characters/***REMOVED***/gu-zi-hang-d55b6786b875

curl 'https://ro.chub.ai/api/characters/***REMOVED***/gu-zi-hang-d55b6786b875?full=true&nocache=0.9723692798668624' \
  -H 'accept: */*' \
  -H 'accept-language: zh-CN,zh;q=0.9' \
  -H 'ch-api-key: ***REMOVED***' \
  -H 'origin: https://chub.ai' \
  -H 'priority: u=1, i' \
  -H 'referer: https://chub.ai/characters/***REMOVED***/gu-zi-hang-d55b6786b875' \
  -H 'samwise: ***REMOVED***' \
  -H 'sec-ch-ua: "Not A(Brand";v="8", "Chromium";v="132", "Google Chrome";v="132"' \
  -H 'sec-ch-ua-mobile: ?0' \
  -H 'sec-ch-ua-platform: "Windows"' \
...
# https://chub.ai/edit_character/***REMOVED***/gu-zi-hang-d55b6786b875
curl 'https://ro.chub.ai/api/characters/***REMOVED***/gu-zi-hang-d55b6786b875?full=true&nocache=0.5691935965988969' \
  -H 'accept: */*' \
...
curl 'https://gateway.chub.ai/api/core/characters/***REMOVED***/gu-zi-hang-d55b6786b875' \
  -X 'PUT' \
  -H 'accept: */*' \
  -H 'accept-language: zh-CN,zh;q=0.9,en;q=0.8' \
  -H 'ch-api-key: ***REMOVED***' \
